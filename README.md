...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    ...
    // Add language switcher to the left div
    const leftDiv = document.querySelector("#nav-menu div[style='margin-left: 20px;']");
    const enLink = document.createElement("a");
    enLink.href = "/";
    enLink.textContent = "EN";
    const krLink = document.createElement("a");
    krLink.href = "/kr";
    krLink.textContent = "한국어";
    krLink.style.marginLeft = "15px";
    leftDiv.appendChild(enLink);
    leftDiv.appendChild(krLink);
    ...
    langSwitch.style.marginLeft = "auto"; // Pushes it to the right
    const enLink = document.createElement("a");
    enLink.href = "/";
    enLink.textContent = "EN";
    const krLink = document.createElement("a");
    ...
    krLink.textContent = "한국어";
    krLink.style.marginLeft = "15px";
    navLinksContainer.appendChild(enLink);
    navLinksContainer.appendChild(krLink);
