...
- **레시피 저장 및 관리 시스템**
  ...
  - Flutter Image Compress를 활용한 이미지 압축과 리사이징을 통해 업로드 시간을 단축하고 스토리지 비용을 최적화했으며, API 토큰 사용량 **35% 절감**과 생성 속도 향상 달성
...
- **해결 방법 구현**
  ...
  - Flutter Image Compress로 JPEG 85% 품질 압축, 해상도 유지하면서 파일 용량 대폭 축소
