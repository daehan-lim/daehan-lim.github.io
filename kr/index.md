...
## 👋 소개
최신 안드로이드 개발 기술과 성능 최적화, 사용자 경험 개선, 데이터 기반 접근으로 모바일 앱을 혁신하는 소프트웨어 엔지니어입니다. MVVM 아키텍처와 Jetpack 컴포넌트를 도입해 안정적이고 유지 보수성이 높은 애플리케이션을 구현했습니다. 머신러닝 연구를 통해 고도화된 데이터 처리, 알고리즘 최적화, 분산 시스템 구축 경험을 쌓았으며, 이는 모바일 앱의 성능 개선과 확장성 있는 아키텍처 역량을 키우는 데 크게 기여했습니다
